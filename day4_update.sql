...
==============================================================================*/  
   ...
   CREATE TABLE tedarikciler  -- parent
    ...
    (
        ...
        on delete cascade
        -- cocuk tabloda babada olmayan bir veri giremeyiz babasız cocuk olmaz
    );    
...
/* -----------------------------------------------------------------------------
  ORNEK3: vergi_no’su 101 olan tedarikcinin firma ismini 'casper' ve irtibat_ismi’ni 
...
/*-----------------------------------------------------------------------------
 ...
 degistiriniz.
 -----------------------------------------------------------------------------*/
   -- eski listeye donmek gerek tedarikcileri düzeltcez cunkü ipek bilgin casper doldu
 delete from tedarikciler; -- bosalttık  tedarikcileri insertlerini tekrar yapıyoz
 -- urunler dde bosaldi cunku baba gidince cocuk ta gitti onun icin urunlerin insertlerinide tekrar yapiyoruz
 update urunler set urun_isim =(select firma_ismi from tedarikciler where irtibat_ismi = 'Adam Eve')-- parantez ici apple ı kastediyor
 where musteri_isim='Ali Bak';
/*------------------------------------------------------------------------------
 ORNEK9: Laptop satin alan musterilerin ismini, firma_ismi  Apple’in irtibat_isim'i ile 
 degistirin
 -----------------------------------------------------------------------------*/
  update urunler set musteri_isim =(select irtibat_ismi from tedarikciler where firma_ismi = 'Apple')-- parantez ici adam eve yi kastediyor
