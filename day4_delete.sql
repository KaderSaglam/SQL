...
/* -----------------------------------------------------------------------------
 ...
 -- delete from ogrenciler where isim='Kemal Yasa'|isim='Mustafa Bak';
/* ----------------------------------------------------------------------------
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/     
    delete from ogrenciler where id in ('123','125','126'); -- tek tırnak koymadanda yapabiliriz
    -- delete from ogrenciler where id=123 or id=125 or id=126;
    
/* ----------------------------------------------------------------------------
  ORNEK7:  TABLODAKİ TÜM KAYITLARI SİLELİM..
 -----------------------------------------------------------------------------*/     
   delete from ogrenciler; -- ogrenciler tablosuna dokunma ama icerdeki verileri sil demek -- ic cephe
   -- tablonun tamamını  silmek istiyorsak drop kullaniriz dis cephe
...
/* ======================== DELETE - TRUNCATE - DROP ============================   
  ...
  1-) TRUNCATE komutu DELETE komutu gibi bir tablodaki verilerin tamamını siler.
    ...
    tabloya veri ekleme, tablodan veri güncelleme, silme ve veri sorugulama işlemlerinde kullanılan komutlardır. 
    Bu komutlar, yaptıkları işlemlerin baş harflerinin alınmasından oluşan CRUD kelimesi ile de tabir edilir.
    ----------------------*/
    /*
...
Verilerin tutulduğu nesneler olan tabloların yaratılmasını, silinmesini ve bazı temel özelliklerinin düzenlenmesini sağlar.
 En yaygın kullanılan DDL komutları şunlardır: CREATE TABLE : Veritabanı üzerinde bir tablo yaratmak için kullanılır.
    */
         TRUNCATE TABLE ogrenciler;  -- doğru yazım -- kimse getiremez geri 
         -- tablo kaybolmuyor bilgiler gidiyor
...
==============================================================================*/ 
 INSERT INTO ogrenciler VALUES(123, 'Ali Can', 'Hasan',75);
    ...
    INSERT INTO ogrenciler VALUES(126, 'Nesibe Yilmaz', 'Ayse',95);
    INSERT INTO ogrenciler VALUES(127, 'Mustafa Bak', 'Can',99);
  savepoint abc; -- bunu abc kutusunda sakla  bununla birlikte run edersek hem  abc kutusunda hem de dosyamızda saklar
  -- inanmazsak boyle bakarız select * from ogrenciler;
  delete from ogrenciler;-- tabloyu sildik ama abc de duruyor
  rollback to abc; -- boyle dersek tablo eski haline geri geliyor
  -- drop table ogrenciler; dersek abc kutusuda gider 
