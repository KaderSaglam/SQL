...
CREATE TABLE calisanlar 
 ...
 -- markada  calisanlarin isimlerini ve maaşlarini listeleyin
  ...
  -----------------------------------------------------------------------------*/ 
  select marka id, calisan_sayisi from markalar
  where marka_isim in(select isyeri from calisanlar where sehir ='Ankara');-- wakko didas pierre cardini dondurdu
...
==============================================================================*/   
 ...
 where markalar.marka_isim=calisanlar.isyeri ) as  toplam_maas -- ismini as toplam_maas diye degistirdik
 from markalar;
 /* -----------------------------------------------------------------------------
