/*======================= CONSTRAINTS - KISITLAMALAR ======================================
 ...
 INSERT INTO calisanlar VALUES( '10002', 'Mehmet Yılmaz' ,12000, '2018-04-14');
   ...
   INSERT INTO calisanlar VALUES('10011', null, 5500, '2018-04-24'); -- null anlam ifade etmediği icin 2. null unique kısıtlamasını bozmaz kod calısır
    INSERT INTO calisanlar VALUES('10004', 'Veli Han', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10005', 'Mustafa Ali', 5000, '2018-04-14'); 
    INSERT INTO calisanlar VALUES('10006', 'Canan Yaş', NULL, '2019-04-12'); -- maas null olamaz
    INSERT INTO calisanlar VALUES('10003', 'CAN', 5000, '2018-04-14');
    INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); -- can zaten var ikinci defa yazınca hata verir
    INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14'); -- maas int oldugu icin '' olamaz
    INSERT INTO calisanlar VALUES('', 'osman', 2000, '2018-04-14'); -- id char oldugu icin '' kabul eder
    INSERT INTO calisanlar VALUES('10002', 'ayse yılmaz', 2000, '2018-04-14'); -- id tekrarlı olmaz unique olmali id CHAR(5) PRIMARY KEY, -- not null+ unique
     INSERT INTO calisanlar VALUES(null, 'ayse yalmaz', 2500, '2018-04-14'); -- id null olamaz PRIMARY KEY, -- not null
...
----------------------------------------------------------------*/
    ...
    );-- calısanlar baba taplo adresler child tablo baba da bağlama yapılacak key PRIMARY KEY, -- not null+ unique olmalı
    -- CONSTRAINT id_clsnlr kısıtlama ismi birden fazla child tablo olursa karısmasın diye isim veriyoruz
    -- FOREIGN KEY(adres_id) child'in baba ya baglandıgı key'i
    -- REFERENCES calisanlar(id) baba nın bagalanan key'i 
    INSERT INTO adresler VALUES('10003','Mutlu Sok', '40.Cad.','IST');
    INSERT INTO adresler VALUES('10003','Can Sok', '50.Cad.','Ankara');
    INSERT INTO adresler VALUES('10002','Ağa Sok', '30.Cad.','Antep');
    -- parent tabloda olmayan id ile child a ekleme yapamaz 
    -- FOREIGN KEY'ye null değeri atanabilir. 
    INSERT INTO adresler VALUES(NULL,'Ağa Sok', '30.Cad.','Antep');
    
    select* from adresler;
    -- bagantılı tablolarda child'i silmeden PRENT'İ SİLmez
    drop table adresler;
